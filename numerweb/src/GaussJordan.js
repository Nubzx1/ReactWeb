        ...
        <Layout>
            <Content style={{ margin: '0 16px' }}>
                ...
                <Breadcrumb style={{ margin: '16px 0' }}>
                    <Breadcrumb.Item>GaussJordan</Breadcrumb.Item>
                    <Breadcrumb.Item>Method</Breadcrumb.Item>
                </Breadcrumb>
                <div style={{ padding: 24, background: '#fff', minHeight: 30 }}><h1>GaussJordan</h1>
                    <Row>
                        <Col span={8}>
                    ...
                    <Row>
                        <Col span={8}>
                            <div>
                                <Button onClick={GaussJordancode} type="primary">Submit</Button>
                            </div>
                        </Col>
                    </Row>
